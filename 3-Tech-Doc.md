...
برای تولید این دستور، می‌توانید از [gui.py](https://github.com/SharifAIChallenge/AIC21-Game/blob/main/server/gui.py) ای که در کنار سرور در ریپوی بازی قرار داده‌شده‌است نیز استفاده کنید. نحوه‌ی استفاده از آن را در [این بخش](https://aichallenge.ir/dashboard/doc/Tech-Doc#%D8%A7%D8%AC%D8%B1%D8%A7%DB%8C-gui.py) می‌توانید مشاهده کنید. 
