...
برای تولید این دستور، می‌توانید از [gui.py](https://github.com/SharifAIChallenge/AIC21-Game/blob/main/server/gui.py) ای که در کنار سرور در ریپوی بازی قرار داده‌شده‌است نیز استفاده کنید. نحوه‌ی استفاده از آن را در [این بخش]() می‌توانید مشاهده کنید.  
